...
module TLArbiter_5(
  ...
  input  [1:0]  sources_0_bits_source,	// tilelink/src/xbar/TLArbiter.scala:62:58
                sources_0_bits_sink,	// tilelink/src/xbar/TLArbiter.scala:62:58
  input         sources_0_bits_denied,	// tilelink/src/xbar/TLArbiter.scala:62:58
  ...
  input  [1:0]  sources_1_bits_source,	// tilelink/src/xbar/TLArbiter.scala:62:58
                sources_1_bits_sink,	// tilelink/src/xbar/TLArbiter.scala:62:58
  input         sources_1_bits_denied,	// tilelink/src/xbar/TLArbiter.scala:62:58
  ...
  output [1:0]  sink_bits_source,	// tilelink/src/xbar/TLArbiter.scala:61:16
                sink_bits_sink,	// tilelink/src/xbar/TLArbiter.scala:61:16
  output        sink_bits_denied,	// tilelink/src/xbar/TLArbiter.scala:61:16
  ...
  wire        beatsIn_0 = ~(_beatsIn_T_1[3]);	// tilelink/src/bundle/TLLink.scala:53:71, tilelink/src/utils/OH1.scala:26:{6,31,36}
  wire [18:0] _beatsIn_T_5 = 19'hF << sources_1_bits_size;	// tilelink/src/utils/OH1.scala:26:31
  wire        beatsIn_1 = ~(_beatsIn_T_5[3]);	// tilelink/src/bundle/TLLink.scala:53:71, tilelink/src/utils/OH1.scala:26:{6,31,36}
  ...
  wire        maskedBeats_0 = winner_0 & beatsIn_0;	// tilelink/src/bundle/TLLink.scala:53:71, tilelink/src/xbar/TLArbiter.scala:86:47, :92:67
  wire        maskedBeats_1 = winner_1 & beatsIn_1;	// tilelink/src/bundle/TLLink.scala:53:71, tilelink/src/xbar/TLArbiter.scala:87:60, :92:67
  ...
  assign sink_bits_sink =
    (state_0 ? sources_0_bits_sink : 2'h0) | (state_1 ? sources_1_bits_sink : 2'h0);	// dependencies/chisel3/src/main/scala/chisel3/util/Mux.scala:27:73, tilelink/src/xbar/TLArbiter.scala:97:24
  assign sink_bits_denied =
    state_0 & sources_0_bits_denied | state_1 & sources_1_bits_denied;	// dependencies/chisel3/src/main/scala/chisel3/util/Mux.scala:27:73, tilelink/src/xbar/TLArbiter.scala:97:24
